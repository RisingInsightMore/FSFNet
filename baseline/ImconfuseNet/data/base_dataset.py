...
def get_params(opt, size):
    ...
    if opt.preprocess == 'resize_and_crop':
        new_h = opt.image_size
        new_w = opt.image_size
    elif opt.preprocess == 'scale_width_and_crop':
        new_w = opt.image_size
        new_h = opt.image_size * h // w
...
def get_transform(opt, params=None, grayscale=False, method=transforms.InterpolationMode.BICUBIC, convert=True):
    ...
    if 'resize' in opt.preprocess:
        osize = [opt.image_size, opt.image_size]
        transform_list.append(transforms.Resize(osize, method))
    elif 'scale_width' in opt.preprocess:
        transform_list.append(transforms.Lambda(lambda img: __scale_width(img, opt.image_size, opt.crop_size, method)))
