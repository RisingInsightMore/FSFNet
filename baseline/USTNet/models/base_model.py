...
class BaseModel():
    ...
    def initialize(self, opt):
        ...
        self.save_dir = os.path.join(opt.checkpoints_dir, self.experiment_id)
        self.save_pretrain_dir = os.path.join(opt.checkpoints_dir, self.experiment_id)
        self.load_dir = r""
        self.load_pretrain_dir = r""
